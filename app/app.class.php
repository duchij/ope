...
class app {
	...
	public function openOdbc()
	{
	    ...
	    $res = odbc_pconnect($this->odbcDsn,$this->odbcUser,$this->odbcPass);
	
	    if ($res === false)
	    {
	        echo odbc_errormsg();
	        $this->log->logData(odbc_errormsg(),false,"error to log to medea",true);
	        exit;
	    }
	    return $res;
	}
	...
	public function openOdbc2()
	{
	    ...
	    $res = odbc_connect($this->odbcDsn2,"user_sql7","brana92621");
